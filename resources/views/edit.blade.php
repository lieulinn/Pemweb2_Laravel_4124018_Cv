            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item"><i class="fas fa-angle-right"></i></li>
                        <li class="breadcrumb-item">Ubah Profil Pengguna</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card mb-5">
                    <div class="card-header">
                        <h3 class="card-title">Ubah Profil Pengguna</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 p-md-5 p-sm-4 p-3">
                                <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 col-12">
                                                            <div class="col-12">
                                                                <div class="form-outline mb-4">
                                                                    <label
                                                                        class="form-label fw-bold text-secondary">Nama Depan</label>
                                                                    <input type="text" id="first_name"
                                                                        name="first_name" placeholder="Nama Depan"
                                                                        class="form-control"
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-outline">
                                                                    <label
                                                                        class="form-label fw-bold text-secondary">Nama Belakang</label>
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <textarea class="form-control" placeholder="Tuliskan deskripsi singkat mengenai diri Anda..." id="about_me" name="about_me" rows="4">{{ isset($information['personal_info']['about_me']) ? $information['personal_info']['about_me'] : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                @foreach ($information['education_info'] as $edu_info)
                                                    <div class="card mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label
                                                                    class="form-label fw-bold text-secondary">Deskripsi Pendidikan</label>
                                                ...
                                                @foreach ($information['project_info'] as $project_info)
                                                    <div class="card mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label
                                                                    class="form-label fw-bold text-secondary">Judul Proyek</label>
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label
                                                                    class="form-label fw-bold text-secondary">Deskripsi Proyek</label>
                                                                <textarea class="form-control" placeholder="Deskripsi singkat mengenai proyek yang Anda kerjakan" id="project_description" name="project_description[]"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-outline">
                                                                ...
                                                                <input type="text" id="interest"
                                                                    ...
                                                                    placeholder="Contoh: Membaca, Bersepeda, Berenang"
                                    ...
                                    <div class="form-check d-flex justify-content-center mb-4">
                                        ...
                                        <label for="verify" class="form-check-label text-dark font-weight-bold fw-bold ms-2"> Apakah Anda yakin ingin menyimpan perubahan ini?
                                        </label>
                                    </div>

                                    <!-- Submit button -->
                                    <button type="submit" id="submitbtn" class="btn btn-lg btn-success w-100">Simpan Perubahan</button>
                                </form>
                            </div>
                        </div>
                    </div>
