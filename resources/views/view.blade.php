...
@php
    $lang_names = [
        'af' => 'Afrikaans', 'sq' => 'Albania', 'am' => 'Amharik', 'ar' => 'Arab', 'an' => 'Aragon', 'hy' => 'Armenia',
        'ast' => 'Asturia', 'az' => 'Azerbaijan', 'eu' => 'Basque', 'be' => 'Belarus', 'bn' => 'Bengali', 'bs' => 'Bosnia',
        'br' => 'Breton', 'bg' => 'Bulgaria', 'ca' => 'Katalan', 'zh' => 'Tionghoa / Mandarin', 'co' => 'Korsika',
        'hr' => 'Kroasia', 'cs' => 'Ceko', 'da' => 'Denmark', 'nl' => 'Belanda', 'en' => 'Inggris', 'eo' => 'Esperanto',
        'et' => 'Estonia', 'fo' => 'Faro', 'fil' => 'Filipina', 'fi' => 'Finlandia', 'fr' => 'Prancis', 'gl' => 'Galisia',
        'ka' => 'Georgia', 'de' => 'Jerman', 'el' => 'Yunani', 'gn' => 'Guarani', 'gu' => 'Gujarati', 'ha' => 'Hausa',
        'he' => 'Ibrani', 'hi' => 'Hindi', 'hu' => 'Hungaria', 'is' => 'Islandia', 'id' => 'Indonesia', 'ga' => 'Irlandia',
        'it' => 'Italia', 'ja' => 'Jepang', 'kn' => 'Kannada', 'kk' => 'Kazakh', 'km' => 'Khmer', 'ko' => 'Korea',
        'ku' => 'Kurdi', 'ky' => 'Kirgiz', 'lo' => 'Lao', 'la' => 'Latin', 'lv' => 'Latvia', 'lt' => 'Lituania',
        'mk' => 'Makedonia', 'ms' => 'Melayu', 'ml' => 'Malayalam', 'mt' => 'Malta', 'mr' => 'Marathi', 'mn' => 'Mongolia',
        'ne' => 'Nepal', 'no' => 'Norwegia', 'oc' => 'Oksitan', 'or' => 'Oriya', 'om' => 'Oromo', 'ps' => 'Pashto',
        'fa' => 'Persia', 'pl' => 'Polandia', 'pt' => 'Portugis', 'pa' => 'Punjabi', 'qu' => 'Quechua', 'ro' => 'Rumania',
        'ru' => 'Rusia', 'gd' => 'Gaelik Skotlandia', 'sr' => 'Serbia', 'sh' => 'Serbo-Kroasia', 'sn' => 'Shona',
        'sd' => 'Sindhi', 'si' => 'Sinhala', 'sk' => 'Slowakia', 'sl' => 'Slowenia', 'so' => 'Somali', 'su' => 'Sunda',
        'sw' => 'Swahili', 'sv' => 'Swedia', 'ta' => 'Tamil', 'tt' => 'Tatar', 'te' => 'Telugu', 'th' => 'Thai',
        'bo' => 'Tibet', 'tr' => 'Turki', 'uk' => 'Ukraina', 'ur' => 'Urdu', 'uz' => 'Uzbek', 'vi' => 'Vietnam',
        'cy' => 'Wales', 'xh' => 'Xhosa', 'yi' => 'Yiddi', 'yo' => 'Yoruba', 'zu' => 'Zulu'
    ];
@endphp
            ...
            <div class="col-12">
                <div class="card mb-5">
                    <div class="card-header">
                        <h3 class="card-title">
                            Profil {{ isset($information['personal_info']['first_name']) ? $information['personal_info']['first_name'] : 'Kosong' }}
                            {{ isset($information['personal_info']['last_name']) ? $information['personal_info']['last_name'] : '' }}</h3>
                    </div>
                    <div class="card-body">
                        <div class="container-fluid wrapper">
                            <div class="row">
                                <div class="sidebar-wrapper col-md-4 col-12">
                                        ...
                                        <div class="languages-container container-block">
                                            ...
                                            <ul class="list-unstyled interests-list">
                                                @foreach ($information['language_info'] as $language_info)
                                                    @php
                                                        $lang_code = isset($language_info['language']) ? $language_info['language'] : '';
                                                        $display_lang = isset($lang_names[$lang_code]) ? $lang_names[$lang_code] : ucwords($lang_code);

                                                        $lang_level = isset($language_info['language_level']) ? $language_info['language_level'] : '';
                                                        $level_mapping = [
                                                            'Native' => 'Bahasa Ibu',
                                                            'Fluent' => 'Lancar',
                                                            'Basic' => 'Dasar'
                                                        ];
                                                        $display_level = isset($level_mapping[$lang_level]) ? $level_mapping[$lang_level] : $lang_level;
                                                    @endphp
                                                    <li>{{ $display_lang }}
                                    ...
                                    @if (!empty($information['interest_info']))
                                        <div class="interests-container container-block">
                                            <h2 class="container-block-title">Minat</h2>
                                            <ul class="list-unstyled interests-list">
                                ...
                                <div class="main-wrapper col-md-8 col-12">
                                    ...
                                    @if (!empty($information['skill_info']))
                                        <section class="skills-section section">
                                            <h2 class="section-title"><span class="icon-holder"><i
                                                        class="fa-solid fa-rocket"></i></span>Keahlian &amp; Kemahiran</h2>
                                            <div class="skillset">
